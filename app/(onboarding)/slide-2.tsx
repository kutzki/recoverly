  ...
  return (
    ...
    >
      <View style={[styles.container, { paddingTop: insets.top + 60, paddingBottom: insets.bottom + 40 }]}>
        ...
        <Animated.View entering={FadeInUp.duration(500).delay(100)} style={styles.copy}>
        ...
        <Animated.View entering={FadeInUp.duration(500).delay(150)} style={styles.dots}>
          <View style={styles.dot} />
          <View style={[styles.dot, styles.dotActive]} />
          <View style={styles.dot} />
        </Animated.View>

        <Animated.View entering={FadeInDown.duration(500).delay(200)} style={styles.ctaArea}>
          <TouchableOpacity
            style={styles.button}
            activeOpacity={0.85}
...
const styles = StyleSheet.create({
  ...
  logoImage: { width: width * 0.3, height: width * 0.3 },

  copy:    { alignItems: 'center', marginBottom: 40 },
  heading: { fontFamily: Fonts.poppinsBold, fontSize: 28, color: Colors.text, textAlign: 'center', marginBottom: 16 },
  body:    { fontFamily: Fonts.jost, fontSize: 15, color: Colors.textMuted, textAlign: 'center', lineHeight: 24 },
  ...
  ctaArea: { width: '100%', alignItems: 'center', gap: 16 },
  button: {
