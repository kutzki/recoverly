...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontFamily: Fonts.poppinsBold, color: Colors.text, marginBottom: 12 },
  ...
  palAvatarText: { fontSize: 18, fontFamily: Fonts.poppinsBold, color: Colors.primary },
  palInfo: { flex: 1 },
  palName: { fontSize: 15, fontFamily: Fonts.poppinsBold, color: Colors.text },
  palMeta: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  palDays: { fontSize: 12, color: Colors.primary, fontFamily: Fonts.poppinsMedium },
  ...
  findBtnText: { color: Colors.white, fontFamily: Fonts.poppinsBold, fontSize: 15 },
});
